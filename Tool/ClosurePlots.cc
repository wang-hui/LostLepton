...
//    {"_mu_sb"          , "Search Bins"           ,0   , 69  },
//    {"_mu_iso_sb"          , "Search Bins"           ,0   , 69  },
//    {"_mu_reco_sb"          , "Search Bins"           ,0   , 69  },
//    {"_mu_acc_sb"          , "Search Bins"           ,0   , 69  },
//    {"_el_sb"          , "Search Bins"           ,0   , 69  },
//    {"_lept_sb"        , "Search Bins"           ,0   , 69  },
//    {"_lept_isotrk" , "Search Bins"           ,0   , 69  },
    {"_mu_sb"          , "Search region bin number"           ,0   , NSEARCH_BINS  },
    {"_mu_iso_sb"          , "Search region bin number"           ,0   , NSEARCH_BINS  },
    {"_mu_reco_sb"          , "Search region bin number"           ,0   , NSEARCH_BINS  },
    {"_mu_acc_sb"          , "Search region bin number"           ,0   , NSEARCH_BINS  },
    {"_el_sb"          , "Search region bin number"           ,0   , NSEARCH_BINS  },
    {"_lept_sb"        , "Search region bin number"           ,0   , NSEARCH_BINS  },
    {"_lept_isotrk" , "Search region bin number"           ,0   , NSEARCH_BINS  },
