...
process.load("LostLepton.TagAndProbe.CfiFile_cfi")
process.TagAndProbeVariables.tagMuons = process.demo.clone()
...
## probe passing miniIso or not
#print "miniIso %d" % muonsMiniIso
#process.probesPassingIsoPF020 = cms.InputTag("probeMuons.muonsMiniIso < 0.2")
...
process.muonEffs = cms.EDAnalyzer("TagProbeFitTreeProducer",
    ...
    variables = cms.PSet(
        ...
        #muonsMiniIso = cms.InputTag("probeMuons","muonsMiniIso"),
    ),
